...
-- John Blake Caven Edits --
Version 1, 4/26/22 - added functionality: can now access mouse position without event trigger
...
/*	New Functions: created by John Blake Caven */
